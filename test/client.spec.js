...
describe("Client", function () {
  it("Client", function () {
    ...
    client.applyServer(
      new TextOperation().retain(6)["delete"](1).insert("D").retain(4)
    )
    ...
    expect(
      client.state.outstanding.equals(
    ...
    expect(
      client.state.outstanding.equals(
        new TextOperation().retain(12).insert(" ")
      )
    ).toBe(true)
    ...
    expect(
      client.state.outstanding.equals(
        new TextOperation().retain(17).insert(" ")
      )
    ).toBe(true)
    expect(
    ...
    expect(
      client.state.outstanding.equals(
        new TextOperation().retain(18).insert("Sit")
      )
    ).toBe(true)
    ...
    client.serverRetry()
    expect(
      sentOperation.equals(new TextOperation().retain(22).insert("ma"))
    ).toBe(true)
  })
})
